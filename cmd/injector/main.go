...
func init() {
	...
	flag.BoolVar(&opts.NotHookInstruction, "nhi", false, "not hook random instruction in target function")
	...
	flag.BoolVar(&opts.ReserveCFG, "cfg", false, "reserve load config for enable Control Flow Guard")
